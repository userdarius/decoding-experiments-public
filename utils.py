...
def get_data_prompt(train_dataset, answerable_indices, brief=BRIEF_PROMPTS["default"], num_fewshot=5):
...
def construct_few_shot_prompt(
        *, model, dataset, indices, prompt, brief, brief_always, make_prompt,
        num_generations, metric, cot=False):
...
def get_ptrue_prompt(model, train_dataset, answerable_indices, brief=BRIEF_PROMPTS["default"], num_fewshot=5, num_generations=10,
                     prompt=""):
